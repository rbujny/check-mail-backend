...
output "benchmark_reports_bucket_name" {
  description = "Private Cloud Storage bucket containing detailed benchmark reports."
  value       = google_storage_bucket.benchmark_reports.name
}
